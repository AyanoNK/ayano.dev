  ...
  projects: {
    ...
    bank: {
      title: {
        ...
        es: "Bank SMS Manager (en progreso)",
        ja: "銀行SMSマネージャー（進行中）",
      },
      description: {
    ...
    kimon: {
      title: {
        en: "Kanji Learning Platform - 鬼門 (stale)",
        es: "Plataforma de Aprendizaje de Kanji - 鬼門",
        ja: "漢字学習プラットフォーム - 鬼門",
      },
      description: {
    ...
    poshaus: {
      title: {
        en: "Artist Portfolio Website - Poshaus",
        es: "Sitio Web de Portafolio de Artista - Poshaus",
